...
export default function Home(props) {
  ...
  return (
    <div className="bg-home bg-no-repeat bg-cover h-screen sm:bg-tabletHome sm:h-full lg:bg-desktopHome lg:h-full">
      ...
      >
        <div className="left w-fit flex flex-col gap-4 text-center lg:items-start lg:w-96">
          ...
          <p className="font-body text-base leading-6 lg:text-left lg:text-lg lg:mb-32">
