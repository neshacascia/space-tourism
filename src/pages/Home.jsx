  ...
  return (
    <div className="bg-home bg-no-repeat bg-cover min-h-full sm:bg-tabletHome lg:bg-desktopHome">
      ...
      >
        ...
        <div>
          <Link to="/destination">
            <button className="bg-white text-darkBlue font-h1 text-button h-button w-button rounded-full sm:w-tabletButton sm:h-tabletButton sm:text-3xl sm:mb-20 relative hvr-ripple-out">
              EXPLORE
            </button>
          </Link>
        </div>
